                ...
                <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
                    ...
                    <td class=''>
                        ...
                        <div class="flex gap-3 justify-center items-center w-full">
                            <a href="waresabedonreport.php?id=<?php echo $id; ?>"
                                class='px-3 py-2 cursor-pointer rounded-xl text-white text-sm  bg-purple-700 hover:bg-purple-600  duration-300 transition flex items-center gap-1'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="#fefefe" stroke-width="2" stroke-linecap="round"
                            ...
                            <a href='waresedit.php?id=<?php echo $id; ?>'
                                class='px-3 py-2 cursor-pointer rounded-xl text-white text-sm  bg-green-700 hover:bg-green-600  duration-300 transition flex items-center gap-1'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                            ...
                            <a href='waresdelete.php?id=<?php echo $id; ?>'
                                class='px-3 py-2 cursor-pointer rounded-xl text-white text-sm  bg-red-700 hover:bg-red-600  duration-300 transition flex items-center gap-1'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="#fefefe" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
